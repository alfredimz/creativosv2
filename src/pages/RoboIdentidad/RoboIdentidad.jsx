...
const RoboIdentidad = () => {
  ...
  return (
    <div className="robo-identidad-page">
      <section className="robo-identidad-hero">
        <Container>
          <Row className="justify-content-center text-center">
            <Col lg={8}>
              <h1 className="robo-identidad-hero__title">Aviso de Robo de Identidad</h1>
              <p className="robo-identidad-hero__description">
      ...
      <section className="robo-identidad-intro">
        <Container>
          <Row className="justify-content-center">
            <Col lg={10}>
              <h2 className="robo-identidad-intro__titulo">Nuestro Compromiso con tu Seguridad</h2>
              <p className="robo-identidad-intro__texto">
              ...
              <div className="robo-identidad-intro__alert">
                <p>
      ...
      <section className="robo-identidad-medidas">
        <Container>
          <h2 className="robo-identidad-medidas__titulo text-center mb-5">Medidas de Prevención</h2>
          <Row>
            {medidas.map((medida, index) => (
              <Col key={index} md={6} lg={4} className="mb-4">
                <Card className="robo-identidad-medidas__card h-100">
                  <Card.Body>
                    <div className="robo-identidad-medidas__card-icono">{medida.icono}</div>
                    <h3 className="robo-identidad-medidas__card-titulo">{medida.titulo}</h3>
                    <p className="robo-identidad-medidas__card-descripcion">{medida.descripcion}</p>
                  </Card.Body>
                </Card>
              </Col>
            ))}
      ...
      <section className="robo-identidad-senales">
        <Container>
          <Row className="justify-content-center">
            <Col lg={10}>
              <h2 className="robo-identidad-senales__titulo">Señales de Alerta de Robo de Identidad</h2>
              <p className="robo-identidad-senales__texto">Esté atento a estas señales que podrían indicar que su identidad ha sido comprometida:</p>
              <ul className="robo-identidad-senales__lista">
      ...
      <section className="robo-identidad-acciones">
        <Container>
          <Row className="justify-content-center">
            <Col lg={10}>
              <h2 className="robo-identidad-acciones__titulo">¿Qué hacer si sospechas un robo de identidad?</h2>
              <ol className="robo-identidad-acciones__lista">
                  <li>
      ...
      <section className="robo-identidad-seguridad">
        <Container>
          <Row className="justify-content-center">
            <Col lg={10}>
              <h2 className="robo-identidad-seguridad__titulo">Nuestras Medidas de Seguridad</h2>
              <div className="robo-identidad-seguridad__info">
                <p>
      ...
      <section className="robo-identidad-contacto">
        <Container>
          <Row className="justify-content-center">
            <Col lg={10}>
              <h3 className="robo-identidad-contacto__titulo">Reporta Incidentes de Seguridad</h3>
              <p className="robo-identidad-contacto__texto">
              ...
              <div className="robo-identidad-contacto__info">
              ...
              <p className="robo-identidad-contacto__horario">
      ...
      <section className="robo-identidad-cta">
        <Container>
          <Row className="justify-content-center text-center">
            <Col lg={8}>
              <h2 className="robo-identidad-cta__titulo">Tu Seguridad es Nuestra Prioridad</h2>
              <p className="robo-identidad-cta__texto">
                Mantente informado y protegido. Lee nuestro aviso de privacidad para conocer más sobre cómo manejamos tu información.
              </p>
              <Link to="/privacidad" className="robo-identidad-cta__button">
