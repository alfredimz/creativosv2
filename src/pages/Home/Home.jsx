  ...
  return (
    <div className="home-page">
          ...
          <Row>
            <Col md={4}>
              <div className="service-card renta">
                ...
                <div className="service-image">
                  <img src="/images/renta-contenedores.webp" alt="Renta de contenedores" />
                </div>
            ...
            <Col md={4}>
              <div className="service-card venta">
                <h2>VENTA</h2>
                <div className="service-image">
                  <img src="/images/venta-contenedores-maritimos.png" alt="Venta de contenedores" />
                </div>
            ...
            <Col md={4}>
              <div className="service-card construccion">
                <h2>CONSTRUCCIÓN</h2>
                <div className="service-image">
                  <img src="/images/construccion-contenedores-maritimos.png" alt="Construcción con contenedores" />
                </div>
      ...
      <section className="additional-services">
        <Container fluid className="p-0">
          <Row className="g-0">
            <Col md={6} className="service-feature" style={{ backgroundImage: 'url("/images/transporte-contenedores-maritimos.webp")' }}>
            ...
            <Col md={6} className="service-feature" style={{ backgroundImage: 'url("/images/maniobras-contenedores-maritimos.webp")' }}>
              <div className="service-feature-content">
                <h3>Maniobras</h3>
          ...
          <Row className="g-0">
            <Col md={12} className="service-feature" style={{ backgroundImage: 'url("/images/diseno-arquitectonico-contenedores-maritimos.webp")' }}>
              <div className="service-feature-content">
      ...
      <section className="acabados-section">
        <Container fluid className="p-0">
          <Row className="g-0">
            <Col md={4} className="acabado-item" style={{ backgroundImage: 'url("/images/acabados-interiores-contenedores-maritimos.webp")' }}>
              <div className="acabado-content">
                <h3>Acabados interiores</h3>
                <p>Creamos exteriores que combinan diseño natural y funcionalidad, desde hermosos paisajes hasta terrazas personalizadas, para brindarte un ambiente único que conecta con la naturaleza y eleva tu estilo de vida.</p>
              </div>
            </Col>
            <Col md={4} className="acabado-item" style={{ backgroundImage: 'url("/images/acabados-interiores-contenedores.webp")' }}>
              <div className="acabado-content">
                <h3>Acabados interiores</h3>
            ...
            <Col md={4} className="acabado-item" style={{ backgroundImage: 'url("/images/acabados-exteriores-contenedores-maritimos.webp")' }}>
              <div className="acabado-content">
      ...
      <section className="acabados-section">
        <Container fluid className="p-0">
          <Row className="g-0">
            <Col md={4} className="acabado-item" style={{ backgroundImage: 'url("/images/herreria-contenedores-maritimos.webp")' }}>
              <div className="acabado-content">
                <h3>Herrería</h3>
                <p>Diseñamos soluciones únicas y personalizadas, adaptadas a tus necesidades específicas, fusionando funcionalidad y estética para cada proyecto.</p>
              </div>
            </Col>
            <Col md={4} className="acabado-item" style={{ backgroundImage: 'url("/images/aislamientos-contenedores-maritimos.webp")' }}>
              <div className="acabado-content">
                <h3>Aislamientos</h3>
                <p>Aplicamos pintura esmalte y procesos especializados de sand blast, garantizando acabados de alta durabilidad y cumpliendo con todas las normativas establecidas para ofrecerte calidad y resistencia en cada proyecto.</p>
              </div>
            </Col>
            <Col md={4} className="acabado-item" style={{ backgroundImage: 'url("/images/aislamientos-contenedores.webp")' }}>
              <div className="acabado-content">
                <h3>Aislamientos</h3>
                <p>Trabajamos con fibra de vidrio, madera, foamular y sistemas de aire acondicionado, garantizando materiales de primera calidad para un confort y eficiencia en cada proyecto.</p>
              </div>
